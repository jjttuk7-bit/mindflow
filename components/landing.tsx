...
const moreFeatures = [
  ...
  { icon: MessageSquare, title: "AI Chat 대화", description: "실시간 스트리밍 답변, 대화 맥락 기억, 복사 & DOCX/PDF 내보내기." },
...
const plans = [
  {
    ...
    price: "무료",
    desc: "핵심 기능으로 시작하기",
    features: ["AI Chat 5회/일", "다차원 스마트 태깅", "스트릭 & 데일리 브리핑", "프로젝트 3개", "크롬 확장 & 텔레그램"],
    cta: "무료로 시작",
    highlight: false,
  },
  {
    ...
    price: "$9.99/월",
    desc: "무제한 AI + 고급 인사이트",
    features: ["AI Chat 무제한", "콘텐츠 생성 & 비즈니스 지원", "5축 AI 프로필 & 성장 추적", "주간/월간 인사이트 리포트", "지식 건강 점수 & AI 정리 가이드", "지식 맵 & 연결 시각화", "프로젝트 & 검색 무제한"],
    cta: "Pro 시작하기",
    highlight: true,
  },
]
    ...
    <footer className="border-t border-border/40 py-8 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-muted-foreground">
          ...
          <span className="text-sm">&copy; 2026 Dott</span>
        </div>
