...
[예시]
text "React 컴포넌트 리팩토링 작업 — 불필요한 리렌더링 줄이기" → ["개발", "react", "리팩토링", "성능최적화"]
text "팀 회의에서 Q3 목표 논의. 매출 20% 성장, 신규 유저 확보 전략" → ["비즈니스", "회의록", "q3-목표", "성장전략"]
text "여행 가기 전 짐 싸야 할 것들: 여권, 충전기, 세면도구" → ["여행", "할일", "체크리스트"]
text "오늘 읽은 책에서 좋았던 구절: 습관의 힘은 반복에서 온다" → ["독서", "자기계발", "인사이트"]
link "TypeScript 5.0 새 기능 소개 - 공식 블로그" → ["개발", "typescript", "공식문서", "참고자료"]
link "강남역 근처 이탈리안 맛집 추천 TOP 5" → ["맛집", "강남", "이탈리안", "나중에-가기"]
link "2024 투자 트렌드: AI 관련주 분석" → ["재테크", "투자", "ai", "트렌드분석"]
image "프로젝트 일정표 - 3월 마일스톤" → ["업무", "프로젝트", "일정", "마일스톤"]
image "카페에서 찍은 라떼아트" → ["카페", "음식", "일상"]
voice "내일 오전에 디자인 리뷰 미팅 있고, 오후에 코드 리뷰 해야 돼" → ["업무", "미팅", "코드리뷰", "일정메모"]
voice "새로운 앱 아이디어가 떠올랐는데 AI로 일기 분석하는 건 어떨까" → ["아이디어", "앱개발", "ai", "브레인스토밍"]
